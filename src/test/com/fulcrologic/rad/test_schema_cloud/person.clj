(ns com.fulcrologic.rad.test-schema-cloud.person
  (:require
...
(defattr primary-address ::primary-address :ref
  {::attr/target     :com.fulcrologic.rad.test-schema-cloud.address/id
   ::attr/schema     :production
   ::attr/identities #{::id}})
...
(defattr things ::things :ref
  {::attr/target      :com.fulcrologic.rad.test-schema-cloud.thing/id
   ::attr/cardinality :many
   ::attr/schema      :production
   ::attr/identities  #{::id}})
